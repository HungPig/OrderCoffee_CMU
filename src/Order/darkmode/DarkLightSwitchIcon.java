...
public class DarkLightSwitchIcon implements AnimatedIcon {
    ...
    private Icon darkIcon = new FlatSVGIcon("Order/darkmode/dark.svg", 0.4f);
    private Icon lightIcon = new FlatSVGIcon("Order/darkmode/light.svg", 0.4f);
